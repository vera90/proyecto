/* [ ---- Gebo Admin Panel - dashboard ---- ] */
    ...
    gebo_charts = {
        ...
        fl_2 : function() {
            ...
            elem.qtip({
                prerender: true,
                content: 'Cargando...', // Use a loading message primarily
                position: {
                    viewport: $(window), // Keep it visible within the window if possible
                    target: 'mouse', // Position it in relation to the mouse
        ...
        fl_c : function() {
            ...
            var looq = [
				[new Date('05/23/2013').getTime(),350],
				[new Date('05/24/2013').getTime(),422],
				[new Date('05/25/2013').getTime(),550],
				[new Date('05/26/2013').getTime(),608],
				[new Date('05/27/2013').getTime(),681],
				[new Date('05/28/2013').getTime(),591],
				[new Date('05/29/2013').getTime(),510]
			];
			
			var sports = [
				[new Date('05/23/2013').getTime(),1200],
				[new Date('05/24/2013').getTime(),1400],
				[new Date('05/25/2013').getTime(),1500],
				[new Date('05/26/2013').getTime(),1200],
				[new Date('05/27/2013').getTime(),1340],
				[new Date('05/28/2013').getTime(),1421],
				[new Date('05/29/2013').getTime(),1510]
			];

			var travel = [
				[new Date('05/23/2013').getTime(),200],
				[new Date('05/24/2013').getTime(),930],
				[new Date('05/26/2013').getTime(),500],
				[new Date('05/27/2013').getTime(),153],
				[new Date('05/28/2013').getTime(),184],
				[new Date('05/29/2013').getTime(),355]
			];

			var belleza = [
				[new Date('05/23/2013').getTime(),50],
				[new Date('05/24/2013').getTime(),930],
				[new Date('05/26/2013').getTime(),99],
				[new Date('05/27/2013').getTime(),120],
				[new Date('05/28/2013').getTime(),184],
				[new Date('05/29/2013').getTime(),200]
			];
         
            var clickonero = [
				[new Date('05/23/2013').getTime(),120],
				[new Date('05/24/2013').getTime(),100],
				[new Date('05/26/2013').getTime(),140],
				[new Date('05/27/2013').getTime(),153],
				[new Date('05/28/2013').getTime(),184],
				[new Date('05/29/2013').getTime(),226]
			];

            
            // add 2h to match utc+2
            for (var i = 0; i < looq.length; ++i) {looq[i][0] += 60 * -240 * 1000};
			for (var i = 0; i < sports.length; ++i) {sports[i][0] += 60 * 30 * 1000};
			for (var i = 0; i < travel.length; ++i) {travel[i][0] += 60 * 300 * 1000};
			for (var i = 0; i < belleza.length; ++i) {belleza[i][0] += 60 * 570 * 1000};
			for (var i = 0; i < clickonero.length; ++i) {clickonero[i][0] += 60 * 840 * 1000};
